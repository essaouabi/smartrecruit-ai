...
const CVAnalyzer = () => {
  ...
  const [jobContext, setJobContext] =
    useState(
    ...
    async () => {
      ...
      try {
        ...
        if (
          ...
          alert(
            "Veuillez renseigner les besoins de l’entreprise."
          );
        ...
        <div className="relative z-10 grid grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-green-100 text-lg leading-8 max-w-3xl">
              Analyse intelligente des CV avec matching RH,
              extraction automatique des compétences,
              scoring IA et recommandations recrutement.
            </p>
          ...
          {!result ? (
            ...
            <div className="min-h-[700px] flex flex-col items-center justify-center text-center">
              ...
              <p className="text-gray-500 max-w-lg leading-8 text-lg">
                Importez un CV PDF afin d’obtenir une analyse RH intelligente,
                un score IA et un matching recrutement.
              </p>
                ...
                {[
                  ...
                  (
                    ...
                    >
                      ...
                      <div
                        className={`${item.color} text-2xl mb-3`}
                      >
                        {item.icon}
                      </div>
